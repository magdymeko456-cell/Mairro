...
echo "⏳ 1. تحديث pubspec.yaml وإضافة مكتبات الشطرنج ومحرك Stockfish..."
...
dependencies:
  ...
  # Games Corner (Chess & Stockfish Engine)
  chess: ^0.8.0
  flutter_chess_board: ^2.0.0
  stockfish: ^1.1.0
...
echo "⏳ 2. جاري إضافة الملف للـ Git..."
git add pubspec.yaml

echo "⏳ 3. جاري عمل الـ Commit..."
git commit -m "fix: add flutter_chess_board and stockfish dependencies for chess game"

echo "🚀 4. جاري الرفع التلقائي المدمج إلى جيت هب..."
git push origin main

echo "✅ تم الإصلاح والرفع بنجاح يا تامر! تابع البناء رقم 8 الآن."
