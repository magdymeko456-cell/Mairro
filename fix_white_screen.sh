...
echo "⏳ 1. إعادة كتابة home_screen.dart وتأمين الـ Provider..."
...
echo "⏳ 2. تحديث وتأمين ملف main.dart ومطابقة مسارات الكروت بالملي..."
...
echo "⏳ 3. تعميد التعديلات المستقرة في الـ Git والرفع..."
git add "$HOME_FILE" "$MAIN_FILE"
git commit -m "fix: resolve white screen crash by safely initializing Provider and updating all routes mapping"
git push origin main

echo "🚀 تم الرفع بنجاح يا صاحبي! راقب البناء الجديد، والمرة دي هيفتح على الواجهة الفخمة مباشرة."
