...
HOME_FILE="lib/features/home_screen.dart"
MAIN_FILE="lib/main.dart"

echo "⏳ 1. تحديث وتأمين ملف main.dart لانتظار تهيئة الخدمات ومنع الشاشة البيضاء..."
...
echo "⏳ 2. إعادة صياغة home_screen.dart ليتوافق مع دوال الأصل بالملي..."
cat << 'INNER_EOF' > "$HOME_FILE"
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
...
echo "⏳ 3. عمل Commit و Push كود مواءمة الأصل والتهيئة الآمنة..."
git add "$MAIN_FILE" "$HOME_FILE"
git commit -m "fix: align home screen with original LanguageService API and secure initialization in main to break white screen crash"
git push origin main

echo "🚀 تم الإصلاح والتوافق والرفع بنجاح يا تامر! راقب جيت هب دلوقتي."
